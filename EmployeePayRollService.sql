...
select *from Employee_Payroll_Service.employee_payroll;
...
Alter table employee_payroll add phone_number int(12), add address varchar(50), add department varchar(50);
